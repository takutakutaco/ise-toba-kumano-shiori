...
const dayOne = [
  ['4:45', '大阪を出発'], ['7:15〜7:30頃', '伊勢西ICを出て内宮周辺に駐車'], ['7:40〜8:50', '伊勢神宮・内宮を参拝'], ['8:50〜9:55', 'おはらい町・おかげ横丁を散策'], ['10:00〜10:20', 'ふくすけで伊勢うどん'], ['10:20〜10:30', '駐車場に戻り鳥羽へ出発'], ['11:15〜14:15', '鳥羽水族館を見学'], ['14:15', '熊野市へ移動（途中で休憩1回）'], ['18:00', '紀南荘にチェックイン・夕食'],
];
const dayTwo = [
  ['8:00', '紀南荘を出発'], ['8:50〜9:00頃', '大門坂駐車場に到着'], ['9:15〜9:55', '夫婦杉・多富気王子・石畳を歩く'], ['10:10〜10:40', '熊野那智大社を参拝'], ['10:40〜11:10', '那智山青岸渡寺と三重塔の景色'], ['11:25〜12:05', '飛瀧神社・那智の滝'], ['12:34〜12:39', '路線バスで大門坂へ戻る'], ['12:45頃', 'レンタカーを回収'], ['13:30頃', '大阪へ出発（途中で休憩1回）'], ['19:30', '南森町でレンタカー返却'],
];
